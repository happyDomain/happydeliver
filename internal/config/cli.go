...
func declareFlags(o *Config) {
	...
	flag.StringVar(&o.Analysis.ClamAVAddress, "clamav-address", o.Analysis.ClamAVAddress, "clamd address for attachment scanning (tcp://host:port, unix:///path or host:port; empty = disabled)")
	flag.StringVar(&o.Analysis.VirusTotalAPIKey, "virustotal-api-key", o.Analysis.VirusTotalAPIKey, "VirusTotal API key for attachment hash lookups (empty = disabled)")
	flag.BoolVar(&o.Analysis.VirusTotalUpload, "virustotal-upload", o.Analysis.VirusTotalUpload, "Upload attachments unknown to VirusTotal for analysis (warning: shares file content with VirusTotal)")
	flag.DurationVar(&o.Analysis.ScanTimeout, "scan-timeout", o.Analysis.ScanTimeout, "Timeout for external attachment scans (ClamAV, VirusTotal)")
