<script lang="ts">
    ...
    let blacklistVerdict = $derived.by<Verdict | null>(() => {
        ...
        // No source could answer: either none is enabled, or every
        // enabled one errored. The backend withholds the score in both
        // cases, so the page must not claim the domain is clean.
