...
// itself. It knows nothing of email: what a verdict is worth is the caller's
// business.
package virustotal
...
type Scan struct {
	...
	Malicious  int    // engines calling the file malicious
	Suspicious int    // engines calling the file suspicious, short of malicious
	Positives  int    // engines flagging the file either way: Malicious + Suspicious
