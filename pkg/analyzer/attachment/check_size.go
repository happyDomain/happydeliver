...
// larger than it will read.
//
// It answers the deliverability reading rather than the security one: what the
// reader is told here is that a large file was sent, which is a sending
// decision, and that nothing below was measured on its content, which is ours.
