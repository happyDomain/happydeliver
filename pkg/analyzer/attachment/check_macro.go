...
// macroAdvice is what a reader is told about macros however they were found.
const macroAdvice = "Macros in email attachments are a primary malware infection vector; only enable them from fully trusted sources"
