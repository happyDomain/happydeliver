...
func TestParseIPRevResult(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedResult:   model.IPRevResultResultPass,
		...
		},
		{
			...
			expectedResult:   model.IPRevResultResultFail,
		...
		},
		{
			...
			expectedResult:   model.IPRevResultResultTemperror,
		...
		},
		{
			...
			expectedResult:   model.IPRevResultResultPermerror,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := analyzer.parseIPRevResult(readMethod(t, tt.part))
...
func TestParseAuthenticationResultsHeader_IPRev(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expectedIPRevResult: utils.PtrTo(model.IPRevResultResultPass),
			expectedIP:          utils.PtrTo("195.110.101.58"),
			expectedHostname:    utils.PtrTo("authsmtp74.register.it"),
		},
		{
		...
		},
		{
			...
			expectedIPRevResult: utils.PtrTo(model.IPRevResultResultFail),
			expectedIP:          utils.PtrTo("198.51.100.42"),
			expectedHostname:    nil,
		},
		{
